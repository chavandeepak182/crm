             ...
             <div class="x_panel">
                  ...
                  <div class="x_content">
                    {{-- <form id="demo-form" action="{{ url('add_lead_action')}}" method="POST" enctype="multipart/form-data"> --}}
                        <form id="demo-form" action="{{ url('updated_lead_action')}}" method="POST" enctype="multipart/form-data">
                    <div class="col-sm-12 ">
                        <div class="col-md-6">
                ...
                <div class="col-sm-12 ">
                    ...
                    <div class="col-md-6">
                        ...
                        @if(isset($lead->image) && !empty($lead->image))
                            <img src="{{asset('/storage/app/public/').'/'.$lead->image}}" id="imgTag" class="img-fluid">
                        @else
