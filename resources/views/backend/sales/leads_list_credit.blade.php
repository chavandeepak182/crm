                      ...
                      <tbody>
                       ...
                       @php $p=1; @endphp
                        ...
                        <tr>
                          ...
                          <td>{{ ($led->approved_loan_amount)?$led->approved_loan_amount:'--' }}</td>
                          <td>{{ ($led->disbursed_amount)?$led->disbursed_amount:'--' }}</td>
                          <td>{{ ($led->file_status)?$led->file_status:'--' }}</td>

                          <td>  <a  href="{{ url('creditLogin/'.$led->id) }}"><button class="btn btn-info"  title="Edit Lead" data-toggle="tooltip" ><i class="fa fa-pencil"></i></button></a>
