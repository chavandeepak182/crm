@include('backend.sales.layout.header')
        ...
        @if (Auth::user()->role=="Sales")
          <div class="tile_count">
            ...
            <div class="col-md-6 col-sm-4  tile_stats_count">
              <span class="count_top">Today Leads </span>
...
{{--                    <div class="col-md-6 col-sm-4  tile_stats_count">--}}
{{--                        <span class="count_top">Total Leads</span>--}}
{{--                        <div class="count">@if(isset($leadsTotal) && $leadsTotal > 0) {{$leadsTotal}}@else {{'0'}}@endif</div>--}}
{{--                        --}}{{-- <span class="count_bottom"><i class="green"> </i> From last Week</span> --}}
{{--                    </div>--}}
{{--                    <div class="col-md-6 col-sm-4  tile_stats_count">--}}
{{--                        <span class="count_top">Today Leads </span>--}}
{{--                        <div class="count">@if(isset($leadsLoginLoad) && $leadsLoginLoad > 0) {{$leadsLoginLoad}}@else {{'0'}} @endif</div>--}}
{{--                        --}}{{-- <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i> </i> From last Week</span> --}}
{{--                    </div>--}}
