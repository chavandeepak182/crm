        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{('dashboard')}}" class="site_title"> <span>Deals Of Arya</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{url('/lead_list_admin')}}"><i class="fa fa-dot-circle-o"></i>Manage Leads </a>  </li>
                ...
                {{-- <li><a href="{{url('/blog_list')}}"><i class="fa fa-dot-circle-o"></i>Manage Leads </span></a></li> --}}
